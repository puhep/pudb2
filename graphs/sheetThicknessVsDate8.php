<?php
  ...
  ******************/
  ...
  $db = new Database();
  $sheets = $db->db_query("SELECT avgThickness, thickness1, thickness2, thickness3, thickness4, dateCut, name FROM sheet WHERE ply=8");
...
?>
<head>
  <title>Sheet Thickness Vs Date - 8 Plies</title>
...
<body>
  ...
  <script type="text/javascript">
    ...
    var layout = {
      ...
      title: 'Sheet Thickness Vs Datae -- 8 Plies'
    };
    var data = [trace];
