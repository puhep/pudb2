...
<?php
  ...
  $sql = "SELECT name FROM miscPart WHERE id=$id";
  ...
  <body>
    <div id="wrapper">
      ...
      <main>
        ...
        <form method="get" action="miscPartEdit.php">
        ...
        ?>
        <h2>Pictures</h2>
        <?php show_pictures("miscPart", $id); ?>
        <h2>Misc Files</h2>
        <?php show_files("miscPart", $id); ?>
        <br>
      </main>
    </div>
    <script src="./node_modules/jquery/dist/jquery.min.js" charset="utf-8"></script>
    <script src="./js/getMiscPartInfo.js" charset="utf-8"></script>
