  ...
  <body>
    ...
    <form action="ss_edit_proc.php" method="post" enctype="multipart/form-data">
      <div style="width:300px;">
        ...
        Mass: <input placeholder= "<?php echo $data['mass']; ?>" name="mass" type="number" step="0.01" min="0" style="float:right"><br><br>
        Pipe <br>Material: <input placeholder= "<?php echo $data['pipe_material']; ?>" name="pipe_material" type="text" style="float:right"><br><br>
        Pipe Wall <br>Thickness: <input placeholder= "<?php echo $data['pipe_wall_thickness']; ?>" name="pipe_wall_thickness" type="number" step="0.01" min="0" style="float:right"><br><br>
        Foam Type: <input placeholder= "<?php echo $data['foam_type']; ?>" name="foam_type" type="text" style="float:right"><br><br>
        Ply of <br>Wings: <input placeholder= "<?php echo $data['wings_ply']; ?>" name="wings_ply" type="number" step="1" min="0" style="float:right"><br><br>
        Stack of <br>Airex: <input placeholder= "<?php echo $data['airex_stack']; ?>" name="airex_stack" type="number" step="1" min="0" style="float:right"><br><br>
      </div>
      ...
      <div style="width:340px;">
        Picture File: <input name="pic" type="file" style="float:right">
        <br><br>
      </div>
